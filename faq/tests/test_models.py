...
def test_faq_model_translation():
    ...
    # ✅ Fix: Check that Bengali translation is **not empty**
    assert faq.get_translated_question('bn') is not None  # Ensure it exists
    assert faq.get_translated_answer('bn') is not None  # Ensure it exists
